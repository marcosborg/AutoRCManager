...
class Client extends EventEmitter {
    ...
    async inject() {
        ...
        await exposeFunctionIfAbsent(
            ...
            async () => {
                ...
                if (this._readyInitialized || this._readyInitializing) {
                    return;
                }
                this._readyInitializing = true;
                 ...
                 * @event Client#ready
                 */
                this._readyInitialized = true;
                this._readyInitializing = false;
    ...
    async attachEventListeners() {
        ...
        await this.pupPage.evaluate(() => {
            if (window.__AutoRCOnAddMessageEventAttached) {
                return;
            }

            const { Msg } = window.require('WAWebCollections');
            Msg.on('add', (msg) => {
                if (!msg.isNewMsg || msg.type === 'ciphertext') return;
                window.onAddMessageEvent(window.WWebJS.getMessageModel(msg));
            });

            window.__AutoRCOnAddMessageEventAttached = true;
        });
        return;
