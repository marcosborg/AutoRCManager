...
class WorkshopApiController extends Controller
{
    ...
    public function updateRepair(Request $request, Repair $repair)
    {
        ...
        $rules = [
            ...
            'fuel_level_percentage' => ['nullable', 'integer', 'min:0', 'max:100'],
    ...
    private function repairDetailPayload(Repair $repair): array
    {
        ...
        return [
            ...
            'kilometers_out' => $repair->kilometers_out !== null ? (int) $repair->kilometers_out : null,
            'fuel_level_in_percentage' => $repair->fuel_level_in_percentage !== null ? (int) $repair->fuel_level_in_percentage : null,
