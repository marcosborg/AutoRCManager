...
class ExpeditionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.expeditions.index', compact('brands', 'clients', 'supliers', 'payment_statuses', 'carriers', 'pickup_states'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.expeditions.create', compact('brands', 'buyer_clients', 'carriers', 'clients', 'payment_statuses', 'pickup_states', 'seller_clients', 'supliers'));
    }
}
