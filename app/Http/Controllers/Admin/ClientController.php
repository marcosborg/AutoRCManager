...
class ClientController extends Controller
{
    ...
    public function storePayment(Request $request, Client $client, VehicleTradeInPaymentService $tradeInService)
    {
        abort_if(Gate::denies('client_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        ...
        DB::transaction(function () use ($request, $client, $data, $isTradeInPayment, $tradeInService): void {
            ...
            if ($isTradeInPayment) {
                $tradeInService->create($client, $data, $request->user()?->id);
            }
        });
