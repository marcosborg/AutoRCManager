    ...
    <div class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="{{ route('admin.vehicles.edit', $vehicle->id) }}" class="btn btn-xs btn-primary pull-right">
                    Editar viatura
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('general_state') ? 'has-error' : '' }}">
                            <label class="required"
                                for="general_state_id">{{ trans('cruds.vehicle.fields.general_state') }}</label>
                            <select disabled class="form-control select2" name="general_state_id" id="general_state_id"
                                required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('license') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="license" id="license"
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('foreign_license') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="foreign_license" id="foreign_license"
                                value="{{ old('foreign_license', $vehicle->foreign_license) }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('model') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="model" id="model"
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('version') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="version" id="version"
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('transmission') ? 'has-error' : '' }}">
                            ...
                            <select disabled class="form-control" name="transmission" id="transmission">
                                <option value disabled {{ old('transmission', null) === null ? 'selected' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('year') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="number" name="year" id="year"
                                value="{{ old('year', $vehicle->year) }}" step="1">
                            @if($errors->has('year'))
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('month') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="month" id="month"
                                value="{{ old('month', $vehicle->month) }}">
                            @if($errors->has('month'))
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('license_date') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control date" type="text" name="license_date" id="license_date"
                                value="{{ old('license_date', $vehicle->license_date) }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('color') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="color" id="color"
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('fuel') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="fuel" id="fuel"
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('kilometers') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="number" name="kilometers" id="kilometers"
                                value="{{ old('kilometers', $vehicle->kilometers) }}" step="1">
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('inspec_b') ? 'has-error' : '' }}">
                            ...
                            <input disabled class="form-control" type="text" name="inspec_b" id="inspec_b"
                                value="{{ old('inspec_b', $vehicle->inspec_b) }}">
                                    ...
                                    <tbody>
                                        @foreach($timelogs as $log)
                                            <tr>
                                                ...
                                                <td>€{{ number_format(($log->rounded_minutes / 60) * $hourPrice, 2, ',', '.') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
