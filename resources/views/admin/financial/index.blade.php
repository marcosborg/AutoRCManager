        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $purchaseTotal = $purchaseOps->sum('total');
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $saleTotal = $saleOps->sum('total');
                    $saleBalance = $pvp - $saleTotal;
                    @endphp

                    <div class="d-flex justify-content-between border-bottom py-1">
                        <span><strong>Preço de Venda (PVP)</strong></span>
                        <span><strong>€{{ number_format($pvp, 2, ',', '.') }}</strong></span>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="d-flex justify-content-between border-bottom py-1">
                        ...
                        <span><strong class="{{ $lucro >= 0 ? 'text-success' : 'text-danger' }}">
                                €{{ number_format($lucro, 2, ',', '.') }}</strong>
                        </span>
                    </div>
                    <div class="d-flex justify-content-between py-1">
