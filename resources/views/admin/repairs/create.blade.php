                    ...
                    <form method="POST" action="{{ route("admin.repairs.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('front_windshield') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="front_windshield" id="front_windshield" value="1" {{ old('front_windshield', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('front_windshield_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="front_windshield_text" id="front_windshield_text" value="{{ old('front_windshield_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('front_lights') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="front_lights" id="front_lights" value="1" {{ old('front_lights', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('front_lights_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="front_lights_text" id="front_lights_text" value="{{ old('front_lights_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('rear_lights') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="rear_lights" id="rear_lights" value="1" {{ old('rear_lights', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('rear_lights_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="rear_lights_text" id="rear_lights_text" value="{{ old('rear_lights_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('horn_functionality') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="horn_functionality" id="horn_functionality" value="1" {{ old('horn_functionality', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('horn_functionality_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="horn_functionality_text" id="horn_functionality_text" value="{{ old('horn_functionality_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('wiper_blades_water_level') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="wiper_blades_water_level" id="wiper_blades_water_level" value="1" {{ old('wiper_blades_water_level', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('wiper_blades_water_level_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="wiper_blades_water_level_text" id="wiper_blades_water_level_text" value="{{ old('wiper_blades_water_level_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('brake_clutch_oil_level') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="brake_clutch_oil_level" id="brake_clutch_oil_level" value="1" {{ old('brake_clutch_oil_level', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('brake_clutch_oil_level_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="brake_clutch_oil_level_text" id="brake_clutch_oil_level_text" value="{{ old('brake_clutch_oil_level_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('electrical_systems') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="electrical_systems" id="electrical_systems" value="1" {{ old('electrical_systems', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('electrical_systems_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="electrical_systems_text" id="electrical_systems_text" value="{{ old('electrical_systems_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('engine_coolant_level') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="engine_coolant_level" id="engine_coolant_level" value="1" {{ old('engine_coolant_level', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('engine_coolant_level_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="engine_coolant_level_text" id="engine_coolant_level_text" value="{{ old('engine_coolant_level_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('engine_oil_level') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="engine_oil_level" id="engine_oil_level" value="1" {{ old('engine_oil_level', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('engine_oil_level_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="engine_oil_level_text" id="engine_oil_level_text" value="{{ old('engine_oil_level_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('filters_air_cabin_oil_fuel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="filters_air_cabin_oil_fuel" id="filters_air_cabin_oil_fuel" value="1" {{ old('filters_air_cabin_oil_fuel', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('filters_air_cabin_oil_fuel_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="filters_air_cabin_oil_fuel_text" id="filters_air_cabin_oil_fuel_text" value="{{ old('filters_air_cabin_oil_fuel_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_leaks_engine_gearbox_steering') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_leaks_engine_gearbox_steering" id="check_leaks_engine_gearbox_steering" value="1" {{ old('check_leaks_engine_gearbox_steering', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_leaks_engine_gearbox_steering_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_leaks_engine_gearbox_steering_text" id="check_leaks_engine_gearbox_steering_text" value="{{ old('check_leaks_engine_gearbox_steering_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('brake_pads_disks') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="brake_pads_disks" id="brake_pads_disks" value="1" {{ old('brake_pads_disks', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('brake_pads_disks_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="brake_pads_disks_text" id="brake_pads_disks_text" value="{{ old('brake_pads_disks_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('shock_absorbers') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="shock_absorbers" id="shock_absorbers" value="1" {{ old('shock_absorbers', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('shock_absorbers_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shock_absorbers_text" id="shock_absorbers_text" value="{{ old('shock_absorbers_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('tire_condition') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="tire_condition" id="tire_condition" value="1" {{ old('tire_condition', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('tire_condition_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tire_condition_text" id="tire_condition_text" value="{{ old('tire_condition_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('battery') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="battery" id="battery" value="1" {{ old('battery', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('battery_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="battery_text" id="battery_text" value="{{ old('battery_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('spare_tire_vest_triangle_tools') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="spare_tire_vest_triangle_tools" id="spare_tire_vest_triangle_tools" value="1" {{ old('spare_tire_vest_triangle_tools', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('spare_tire_vest_triangle_tools_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="spare_tire_vest_triangle_tools_text" id="spare_tire_vest_triangle_tools_text" value="{{ old('spare_tire_vest_triangle_tools_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_clearance') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_clearance" id="check_clearance" value="1" {{ old('check_clearance', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_clearance_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_clearance_text" id="check_clearance_text" value="{{ old('check_clearance_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_shields') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_shields" id="check_shields" value="1" {{ old('check_shields', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_shields_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_shields_text" id="check_shields_text" value="{{ old('check_shields_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('paint_condition') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="paint_condition" id="paint_condition" value="1" {{ old('paint_condition', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('paint_condition_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="paint_condition_text" id="paint_condition_text" value="{{ old('paint_condition_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('dents') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="dents" id="dents" value="1" {{ old('dents', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('dents_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dents_text" id="dents_text" value="{{ old('dents_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('diverse_strips') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="diverse_strips" id="diverse_strips" value="1" {{ old('diverse_strips', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('diverse_strips_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="diverse_strips_text" id="diverse_strips_text" value="{{ old('diverse_strips_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('diverse_plastics_check_scratches') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="diverse_plastics_check_scratches" id="diverse_plastics_check_scratches" value="1" {{ old('diverse_plastics_check_scratches', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('diverse_plastics_check_scratches_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="diverse_plastics_check_scratches_text" id="diverse_plastics_check_scratches_text" value="{{ old('diverse_plastics_check_scratches_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('wheels') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="wheels" id="wheels" value="1" {{ old('wheels', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('wheels_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="wheels_text" id="wheels_text" value="{{ old('wheels_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('bolts_paint') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="bolts_paint" id="bolts_paint" value="1" {{ old('bolts_paint', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('bolts_paint_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bolts_paint_text" id="bolts_paint_text" value="{{ old('bolts_paint_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('seat_belts') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="seat_belts" id="seat_belts" value="1" {{ old('seat_belts', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('seat_belts_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="seat_belts_text" id="seat_belts_text" value="{{ old('seat_belts_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('radio') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="radio" id="radio" value="1" {{ old('radio', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('radio_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="radio_text" id="radio_text" value="{{ old('radio_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('air_conditioning') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="air_conditioning" id="air_conditioning" value="1" {{ old('air_conditioning', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('air_conditioning_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="air_conditioning_text" id="air_conditioning_text" value="{{ old('air_conditioning_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('front_rear_window_functionality') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="front_rear_window_functionality" id="front_rear_window_functionality" value="1" {{ old('front_rear_window_functionality', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('front_rear_window_functionality_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="front_rear_window_functionality_text" id="front_rear_window_functionality_text" value="{{ old('front_rear_window_functionality_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('seats_upholstery') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="seats_upholstery" id="seats_upholstery" value="1" {{ old('seats_upholstery', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('seats_upholstery_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="seats_upholstery_text" id="seats_upholstery_text" value="{{ old('seats_upholstery_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('sun_visors') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="sun_visors" id="sun_visors" value="1" {{ old('sun_visors', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('sun_visors_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="sun_visors_text" id="sun_visors_text" value="{{ old('sun_visors_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('carpets') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="carpets" id="carpets" value="1" {{ old('carpets', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('carpets_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="carpets_text" id="carpets_text" value="{{ old('carpets_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('trunk_shelf') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="trunk_shelf" id="trunk_shelf" value="1" {{ old('trunk_shelf', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('trunk_shelf_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="trunk_shelf_text" id="trunk_shelf_text" value="{{ old('trunk_shelf_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('buttons') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="buttons" id="buttons" value="1" {{ old('buttons', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('buttons_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="buttons_text" id="buttons_text" value="{{ old('buttons_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('door_panels') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="door_panels" id="door_panels" value="1" {{ old('door_panels', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('door_panels_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="door_panels_text" id="door_panels_text" value="{{ old('door_panels_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('locks') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="locks" id="locks" value="1" {{ old('locks', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('locks_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="locks_text" id="locks_text" value="{{ old('locks_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('interior_covers_headlights_taillights') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="interior_covers_headlights_taillights" id="interior_covers_headlights_taillights" value="1" {{ old('interior_covers_headlights_taillights', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('interior_covers_headlights_taillights_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="interior_covers_headlights_taillights_text" id="interior_covers_headlights_taillights_text" value="{{ old('interior_covers_headlights_taillights_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('open_close_doors_remote_control_all_functions') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="open_close_doors_remote_control_all_functions" id="open_close_doors_remote_control_all_functions" value="1" {{ old('open_close_doors_remote_control_all_functions', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('open_close_doors_remote_control_all_functions_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="open_close_doors_remote_control_all_functions_text" id="open_close_doors_remote_control_all_functions_text" value="{{ old('open_close_doors_remote_control_all_functions_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('turn_on_ac_check_glass') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="turn_on_ac_check_glass" id="turn_on_ac_check_glass" value="1" {{ old('turn_on_ac_check_glass', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('turn_on_ac_check_glass_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="turn_on_ac_check_glass_text" id="turn_on_ac_check_glass_text" value="{{ old('turn_on_ac_check_glass_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_engine_lift_hood') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_engine_lift_hood" id="check_engine_lift_hood" value="1" {{ old('check_engine_lift_hood', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_engine_lift_hood_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_engine_lift_hood_text" id="check_engine_lift_hood_text" value="{{ old('check_engine_lift_hood_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('connect_vehicle_to_scanner_check_errors') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="connect_vehicle_to_scanner_check_errors" id="connect_vehicle_to_scanner_check_errors" value="1" {{ old('connect_vehicle_to_scanner_check_errors', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('connect_vehicle_to_scanner_check_errors_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="connect_vehicle_to_scanner_check_errors_text" id="connect_vehicle_to_scanner_check_errors_text" value="{{ old('connect_vehicle_to_scanner_check_errors_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_chassis_confirm_with_registration') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_chassis_confirm_with_registration" id="check_chassis_confirm_with_registration" value="1" {{ old('check_chassis_confirm_with_registration', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_chassis_confirm_with_registration_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_chassis_confirm_with_registration_text" id="check_chassis_confirm_with_registration_text" value="{{ old('check_chassis_confirm_with_registration_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('manufacturer_plate') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="manufacturer_plate" id="manufacturer_plate" value="1" {{ old('manufacturer_plate', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('manufacturer_plate_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manufacturer_plate_text" id="manufacturer_plate_text" value="{{ old('manufacturer_plate_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_chassis_stickers') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_chassis_stickers" id="check_chassis_stickers" value="1" {{ old('check_chassis_stickers', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_chassis_stickers_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_chassis_stickers_text" id="check_chassis_stickers_text" value="{{ old('check_chassis_stickers_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('check_gearbox_oil') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="check_gearbox_oil" id="check_gearbox_oil" value="1" {{ old('check_gearbox_oil', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('check_gearbox_oil_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="check_gearbox_oil_text" id="check_gearbox_oil_text" value="{{ old('check_gearbox_oil_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('obs_2') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="obs_2" id="obs_2">{{ old('obs_2') }}</textarea>
                            @if($errors->has('obs_2'))
                        ...
                        <div class="form-group {{ $errors->has('timestamp') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="timestamp" id="timestamp" value="{{ old('timestamp') }}">
