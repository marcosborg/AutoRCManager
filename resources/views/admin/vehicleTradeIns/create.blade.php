                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $tradeInErrors->has('trade_in_iuc_month') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="trade_in_iuc_month" id="trade_in_iuc_month" required>
                                <option value></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $tradeInErrors->has('trade_in_iuc_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="trade_in_iuc_value" id="trade_in_iuc_value" value="{{ old('trade_in_iuc_value') }}" step="0.01" min="0">
