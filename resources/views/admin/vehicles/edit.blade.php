                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicles.update", [$vehicle->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('amount_paid') ? 'has-error' : '' }}">
                            <label for="amount_paid">{{ trans('cruds.vehicle.fields.amount_paid') }}</label>
                            <textarea class="form-control" name="amount_paid" id="amount_paid">{{ old('amount_paid', $vehicle->amount_paid) }}</textarea>
                            @if($errors->has('amount_paid'))
                                <span class="help-block" role="alert">{{ $errors->first('amount_paid') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.vehicle.fields.amount_paid_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('client_amount_paid') ? 'has-error' : '' }}">
                            <label for="client_amount_paid">{{ trans('cruds.vehicle.fields.client_amount_paid') }}</label>
                            <textarea class="form-control" name="client_amount_paid" id="client_amount_paid">{{ old('client_amount_paid', $vehicle->client_amount_paid) }}</textarea>
                            @if($errors->has('client_amount_paid'))
                                <span class="help-block" role="alert">{{ $errors->first('client_amount_paid') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.vehicle.fields.client_amount_paid_helper') }}</span>
                        </div>
