                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('amount_paid') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="amount_paid" id="amount_paid">{{ old('amount_paid') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('client_amount_paid') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="client_amount_paid" id="client_amount_paid">{{ old('client_amount_paid') }}</textarea>
